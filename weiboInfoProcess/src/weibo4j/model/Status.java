...
public class Status extends WeiboResponse {
	...
	private String jsonString;                           //获取json字符串，by WH
	private boolean retweetedFlag = false;
	public Status()
	{
	...
	public String toString() {
		...
		if(retweetedFlag){
			return "{\"idstr\":\"" + idstr + "\",\"created_at\":\""
					+ createdAt + "\",\"id\":\"" + id + "\",\"text\":\"" + text.replaceAll("\"", "'").replaceAll("\\", "") + "\",\"source\":\""
					+ source + "\",\"favorited\":\"" + favorited + "\",\"truncated\":\""
					+ truncated + "\",\"in_reply_to_status_id\":\"" + inReplyToStatusId
					+ "\",\"in_reply_to_user_id\":\"" + inReplyToUserId
					+ "\",\"in_reply_to_screen_name\":\"" + inReplyToScreenName.replaceAll("\"", "'")
					+ "\",\"thumbnail_pic\":\"" + thumbnailPic.replaceAll("\"", "'") + "\",\"bmiddle_pic\":\""
					+ bmiddlePic.replaceAll("\"", "'") + "\",\"original_pic\":\"" + originalPic.replaceAll("\"", "'")
					+ "\",\"retweeted_status_id\":\"" + retweetedStatus.getId() + "\",\"retweeted_status_text\":\"" 
					+ retweetedStatus.getText().replaceAll("\"", "'") + "\",\"geo\":\"" + geo.replaceAll("\"", "'")
					+ "\",\"latitude\":\"" + latitude + "\",\"longitude\":\"" + longitude
					+ "\",\"reposts_count\":\"" + repostsCount + "\",\"comments_count\":\""
					+ commentsCount + "\",\"attitudes_count\":\"" + attitudesCount + "\",\"mid\":\"" 
					+ mid.replaceAll("\"", "'") + "\",\"mlevel\":\"" + mlevel
					+ "\"}";
		}else{
			return "{\"idstr\":\"" + idstr + "\",\"created_at\":\""
					+ createdAt + "\",\"id\":\"" + id + "\",\"text\":\"" + text.replaceAll("\"", "'").replaceAll("\\", "") + "\",\"source\":\""
