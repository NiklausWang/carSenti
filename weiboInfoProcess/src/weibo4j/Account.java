...
public class Account extends Weibo {
	...
	public String getAge(String uid) throws WeiboException, JSONException {
		return client.get(
	...
	public String getSchool(String uid) throws WeiboException, JSONException {
		return client.get(
				WeiboConfig.getValue("baseURL") + "account/profile/education.json",
				new PostParameter[] { new PostParameter("uid", uid) },
